    ...
    >
      <ScrollView contentContainerStyle={styles.inner} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          {[
            { name: 'full_name' as const, label: 'Full Name', placeholder: 'Marcus Thompson', keyboardType: 'default' as const },
            { name: 'email' as const, label: 'Email', placeholder: 'you@example.com', keyboardType: 'email-address' as const },
            { name: 'phone' as const, label: 'Phone Number', placeholder: '+1 416 555 0100', keyboardType: 'phone-pad' as const },
            { name: 'password' as const, label: 'Password', placeholder: '••••••••', keyboardType: 'default' as const },
